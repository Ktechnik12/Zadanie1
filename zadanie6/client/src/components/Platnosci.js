...
function Platnosci({ cartItems, onPaymentSuccess }) {
  ...
  return (
    <div className="platnosci-container">
      <h1>Płatności</h1>
      {success ? (
        <div data-cy="payment-success" className="success-message">
        ...
        <div className="payment-content">
          <form className="payment-form" onSubmit={handleSubmit}>
            ...
            {error && (
              <div data-cy="payment-error" className="error-message">
                {error}
              </div>
            )}
            ...
            <div className="form-section">
              ...
              <div className="order-summary">
                ...
                <div className="summary-total" data-cy="payment-total">
                  <span>Razem:</span>
            ...
            <button data-cy="submit-payment" type="submit" className="submit-btn" disabled={loading}>
